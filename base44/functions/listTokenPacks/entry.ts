...
const DEFAULT_CONFIG = {
  configVersion: 'v2',
  packs: [
    { packId: 'starter_5_pack',  tokens: 5,   price: 0.99,  currency: 'USD', kind: 'starter',       oneTime: true,  label: 'Starter Edge Pack',  description: 'Perfect intro offer — 5 deep reports' },
    { packId: 'tokens_5_pack',   tokens: 5,   price: 1.99,  currency: 'USD', kind: 'standard',      oneTime: false, label: 'Quick Pack',         description: '5 deep AI Edge Reports' },
    { packId: 'tokens_15_pack',  tokens: 15,  price: 4.99,  currency: 'USD', kind: 'standard',      oneTime: false, label: 'Trader Pack',        description: '15 deep AI Edge Reports' },
    { packId: 'tokens_40_pack',  tokens: 40,  price: 10.99, currency: 'USD', kind: 'standard',      oneTime: false, label: 'Growth Pack',        description: '40 deep AI Edge Reports' },
    { packId: 'second_25_pack',  tokens: 25,  price: 5.99,  currency: 'USD', kind: 'second_chance', oneTime: true,  label: 'Second Chance Pack', description: 'Special one-time offer — 25 deep reports' },
    { packId: 'tokens_100_pack', tokens: 100, price: 23.99, currency: 'USD', kind: 'standard',      oneTime: false, label: 'Pro Pack',           description: '100 deep AI Edge Reports' },
    { packId: 'tokens_250_pack', tokens: 250, price: 49.99, currency: 'USD', kind: 'heavy',         oneTime: false, label: 'Whale Pack',         description: 'Best value — 250 deep AI Edge Reports' },
  ],
  eligibilityRules: {
